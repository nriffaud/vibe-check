...
const openModal = () => {
    if (document.getElementById(`chillVibes`).checked&&document.getElementById(`alcohol`).checked) {
        ...
        document.getElementById(`vibeDrink`).innerText=`Pour yourself some Red Wine, or some White Wine. To be honest since you're feeling sad you should drink whatever you want. But wine traditionally does the trick. Our preferred types are Merlot,Cabernets, and Sauvignon Blanc.`;
        document.getElementById(`vibeSongs`).innerText=`Specific songs that will set your vibe will be Dancing On My Own - Robyn, Don't You Remember - Adele, Go Your Own Way - Fleetwood Mac, Ex-Factor - Lauryn Hill, The Winner Takes It All - ABBA, Drivers License - Olivia Rodrigo, All Too Well - Taylor Swift.`;
        document.getElementById(`modal`).style.backgroundImage="url('./images/lonelyVibes.jpg')";
        document.getElementById(`modal`).style.backgroundSize="cover";
        document.getElementById(`modal-textbox`).style.backgroundColor="rgba(137, 196, 244, 0.8)";
    } 
        ...
        document.getElementById(`vibeSongs`).innerText=`Specific songs that will set your vibe will be Don't You Remember - Adele, Go Your Own Way - Fleetwood Mac, Ex-Factor - Lauryn Hill, Dancing On My Own - Robyn, The Winner Takes It All - ABBA, Drivers License - Olivia Rodrigo, All Too Well - Taylor Swift.`;
        document.getElementById(`modal`).style.backgroundImage="url('./images/lonelyVibes.jpg')";
        document.getElementById(`modal`).style.backgroundSize="cover";
        document.getElementById(`modal-textbox`).style.backgroundColor="rgba(137, 196, 244, 0.8)";
    } 
